...
module.exports = {
    ...
    css: [function (module, packer) {
        module.builtType = 'css';
        module.builtSource = module.source;
    }],

    less: [function (module, packer) {
        module.builtType = 'css';
        // todo...
        module.builtSource = module.source;
    }],
    ...
    vue: [function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(module, packer) {
            var _ref3, template, script, style, lines;
    ...
    text: [textProcessor],
    'vue.tpl': [require('./nspack-processor-vue-template-compiler')]
};
