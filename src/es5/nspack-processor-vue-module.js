...
var split_vue_module_1 = require("./split-vue-module");
function default_1(module, packer) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, template, script, style, lines;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    module.builtType = 'js';
                    return [4 /*yield*/, split_vue_module_1.default(module, packer)];
                case 1:
                    _a = _b.sent(), template = _a.template, script = _a.script, style = _a.style;
                    lines = [];
                    if (style) {
